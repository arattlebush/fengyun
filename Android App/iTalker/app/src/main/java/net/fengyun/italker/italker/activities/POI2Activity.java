...
public class POI2Activity extends AppCompatActivity {
    ...
    private void initBaiduMap() {
        ...
        et_key = (EditText) findViewById(R.id.et_key2);
        et_around = (EditText) findViewById(R.id.et_around2);
        et_line = (EditText) findViewById(R.id.et_line2);
        et_start = (EditText) findViewById(R.id.et_start2);
        //et_around.setText(leix);
        //获取地图控件引用
        mMapView = ((MapFragment) getFragmentManager().findFragmentById(R.id.fragment2)).getMapView();
        //百度地图控制对象
...
//                                    .getDistance(), Toast.LENGTH_LONG).show();
    ...
    public void selectBusLine(View view) {
        ...
        poiCitySearchOptions.city("太原").keyword(key);//城市检索的数据设置
    ...
    public void selectWalkingLine(View view) {
        ...
        PlanNode fromeNode = PlanNode.withCityNameAndPlaceName("太原", key);
