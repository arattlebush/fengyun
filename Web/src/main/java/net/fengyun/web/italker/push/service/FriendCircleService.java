...
import net.fengyun.web.italker.push.bean.api.friend.CommentModel;
import net.fengyun.web.italker.push.bean.api.friend.ReleaseFriendCircleModel;
import net.fengyun.web.italker.push.bean.card.CommentCard;
import net.fengyun.web.italker.push.bean.card.FriendCircleCard;
import net.fengyun.web.italker.push.bean.db.Comment;
import net.fengyun.web.italker.push.bean.db.Fabulous;
import net.fengyun.web.italker.push.bean.db.FriendCircle;
import net.fengyun.web.italker.push.bean.db.User;
import net.fengyun.web.italker.push.factory.FriendCircleFactory;
