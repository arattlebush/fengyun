...
import fengyun.android.com.factory.presenter.contact.PersonalContract;
import fengyun.android.com.factory.presenter.contact.PersonalPresenter;
...
public class PersonalActivity extends PresenterToolbarActivity<PersonalContract.Presenter> implements PersonalContract.View {
    ...
    private static final String PIC_INTENT_KEY = "PIC_INTENT_KEY";
    ...
    public static void show(Activity context, View view, String userId) {
